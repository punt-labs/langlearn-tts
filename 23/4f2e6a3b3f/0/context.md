...
create a build so I can test the claude desktop install.

### Prompt 79

There are issues with the directory setting for output. I have to keep manually set this to a hard path without $var - can you research this issue?
...
OK, the above says 4 new comments.

### Prompt 82

OK, I misread the report, that was cycle 1.
...
Version:  (if empty, auto-detected from CHANGELOG.md)
...
- **Quality gate failure**: Fix the issue, then re-run `punt release `.
- **CI failure**: The...
